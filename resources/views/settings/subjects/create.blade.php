...
@section('PageTitle', 'Add Subjects')
@section('content')
                ...
                <div class="col-sm-12">
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            ...
                            <a class="btn btn-success float-right btn-sm" href="{{ route('subjects.index') }}"><i
                                ...
                                <div class="add_item">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="name[]" placeholder="Subject Name" class="form-control" style="height: calc(1.5em + .5rem + 2px); padding: .25rem .5rem;  font-size: .875rem; line-height: 1.5; border-radius: .2rem" required>
                                        </div>
