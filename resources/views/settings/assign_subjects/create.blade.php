...
@section('PageTitle', 'Subject Assignment')
@section('content')
          ...
          <div class="col-sm-12">
                <div class="iq-card">
                      <div class="iq-card-header d-flex justify-content-between">
                         ...
                         <a class="btn btn-success float-right btn-sm" href="{{route('assign.subjects.index')}}"><i class="fa fa-list"></i>  Subject Assignment List</a>                      </div>
                      <hr>
                      <div class="iq-card-body">
                        <form class="form-horizontal" id="quickForm" method="POST" action="{{(@$editData?route('assign.subjects.update',$editData->id):route('assign.subjects.store'))}}">                            @csrf
                            @if (@isset($editData))
                            @method('PATCH')
                            @endif
                        <div class="add_item">
        ...
        <div class="whole_extra_item_add" id="whole_extra_item_add">
            <div class="delete_whole_extra_item_add" id="delete_whole_extra_item_add">
                ...
                <div class="form-group col-md-2" style="padding-top: 0px;">
                    <div class="row mx-1">
                    <span class="btn btn-success btn-sm mr-1 addeventmore"><i class="fa fa-plus-circle"></i></span>
