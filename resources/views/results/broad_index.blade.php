...
@section('PageTitle', 'End of Term Broadsheet Result')
@section('content')
                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                <h4 class="card-title">Broadsheet Result</h4>
                        ...
                        <div class="iq-card-body">
                            ...
                            <form method="POST" action="{{ route('broad.report.generate') }}" target="_blank">
                                @csrf
                                <div class="form-row">
