                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(/assets/media/avatars/blank.png)">
                                        ...
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: @if(Auth::user()->picture == 'default.png') url(/uploads/default.png) @else url(/uploads/avatar/{{Auth::user()->picture}}) @endif" ></div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-4 fv-row">
                                            <input type="text" name="middle_name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Middle name" value="{{Auth::user()->middle_name}}" />
                                        </div>
                                        <!--end::Col-->
                                        <div class="col-lg-4 fv-row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 fv-row">
                                                    {{-- <select class="form-select form-select-solid" data-control="select2" multiple data-hide-search="false" data-placeholder="Select languages" name="speciality[]"> --}}
                                                        <select
                                                        ...
                                                        <option value="Abia" @if(@$user->state == 'Abia') selected @endif>Abia</option>
                                                        <option value="Adamawa" @if(@$user->state == 'Adamawa') selected @endif>Adamawa</option>
                                                        <option value="AkwaIbom" @if(@$user->state == 'AkwaIbom') selected @endif>AkwaIbom</option>
                                                        <option value="Anambra" @if(@$user->state == 'Anambra') selected @endif>Anambra</option>
                                                        <option value="Bauchi" @if(@$user->state == 'Bauchi') selected @endif>Bauchi</option>
                                                        <option value="Bayelsa" @if(@$user->state == 'Bayelsa') selected @endif>Bayelsa</option>
                                                        <option value="Benue" @if(@$user->state == 'Benue') selected @endif>Benue</option>
                                                        <option value="Borno" @if(@$user->state == 'Borno') selected @endif>Borno</option>
                                                        <option value="Cross River" @if(@$user->state == 'Cross River') selected @endif>Cross River</option>
                                                        <option value="Delta" @if(@$user->state == 'Delta') selected @endif>Delta</option>
                                                        <option value="Ebonyi" @if(@$user->state == 'Ebonyi') selected @endif>Ebonyi</option>
                                                        <option value="Edo" @if(@$user->state == 'Edo') selected @endif>Edo</option>
                                                        <option value="Ekiti" @if(@$user->state == 'Ekiti') selected @endif>Ekiti</option>
                                                        <option value="Enugu" @if(@$user->state == 'Enugu') selected @endif>Enugu</option>
                                                        <option value="FCT" @if(@$user->state == 'FCT') selected @endif>FCT</option>
                                                        <option value="Gombe" @if(@$user->state == 'Gombe') selected @endif>Gombe</option>
                                                        <option value="Imo" @if(@$user->state == 'Imo') selected @endif>Imo</option>
                                                        <option value="Jigawa" @if(@$user->state == 'Jigawa') selected @endif>Jigawa</option>
                                                        <option value="Kaduna" @if(@$user->state == 'Kaduna') selected @endif>Kaduna</option>
                                                        <option value="Kano" @if(@$user->state == 'Kano') selected @endif>Kano</option>
                                                        <option value="Katsina" @if(@$user->state == 'Katsina') selected @endif>Katsina</option>
                                                        <option value="Kebbi" @if(@$user->state == 'Kebbi') selected @endif>Kebbi</option>
                                                        <option value="Kogi" @if(@$user->state == 'Kogi') selected @endif>Kogi</option>
                                                        <option value="Kwara" @if(@$user->state == 'Kwara') selected @endif>Kwara</option>
                                                        <option value="Lagos" @if(@$user->state == 'Lagos') selected @endif>Lagos</option>
                                                        <option value="Nasarawa" @if(@$user->state == 'Nasarawa') selected @endif>Nasarawa</option>
                                                        <option value="Niger" @if(@$user->state == 'Niger') selected @endif>Niger</option>
                                                        <option value="Ogun" @if(@$user->state == 'Ogun') selected @endif>Ogun</option>
                                                        <option value="Ondo" @if(@$user->state == 'Ondo') selected @endif>Ondo</option>
                                                        <option value="Osun" @if(@$user->state == 'Osun') selected @endif>Osun</option>
                                                        <option value="Oyo" @if(@$user->state == 'Oyo') selected @endif>Oyo</option>
                                                        <option value="Plateau" @if(@$user->state == 'Plateau') selected @endif>Plateau</option>
                                                        <option value="Rivers" @if(@$user->state == 'Rivers') selected @endif>Rivers</option>
                                                        <option value="Sokoto" @if(@$user->state == 'Sokoto') selected @endif>Sokoto</option>
                                                        <option value="Taraba" @if(@$user->state == 'Taraba') selected @endif>Taraba</option>
