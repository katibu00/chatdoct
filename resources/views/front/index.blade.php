    ...
    <div class="content-wrap">
            ...
            <div class="container clearfix">
                <div class="row align-items-center">
                    <div class="col-12 col-lg">
                        <h3>Try Chatdoct <span>Free</span> and you'll love it!</h3>
                        <span>Starts at just <em>0 NGN/booking</em> afterwards. No Ads, No Gimmicks and No SPAM. Just
                            Real Content.</span>
                    </div>
        ...
        <div class="container clearfix">
            <div class="row justify-content-center mw-lg mx-auto gutter-20">
                ...
                <div class="col-md-3">
                    <a href="{{ route('speciality','speciality=general') }}">
                        <div class="feature-box fbox-center fbox-plain px-3 py-3 rounded-3 bg-light border mx-0">
                            <div class="fbox-icon mb-2">
                ...
                <div class="col-md-3">
                    <a href="{{ route('speciality','speciality=Internal') }}">
                        <div class="feature-box fbox-center fbox-plain px-3 py-3 rounded-3 bg-light border mx-0">
                            <div class="fbox-icon mb-2">
                ...
                <div class="col-md-3">
                    <a href="{{ route('speciality','speciality=Family') }}">
                        <div class="feature-box fbox-center fbox-plain px-3 py-3 rounded-3 bg-light border mx-0">
                            <div class="fbox-icon mb-2">
                            ...
                            <div class="product">
                                ...
                                <div class="card shadow-sm">
                                    ...
                                    <div
                                        ...
                                        <div></div>
                                        <a href="{{route('doctors.details',$user->number)}}" class="button button-red rounded-pill m-0">See Profile</a>
                                    </div>
                                </div>
                            </div>
                        </div>   
        ...
        <div class="section m-0 mt-3 parallax" style="padding: 100px 0; background-color:rgb(61,128,228);"
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="toggle-wrap">
                            ...
                            <div class="toggle">
                                ...
                                <div class="toggle-content">Patiently wait for about 30 minutes after which booking will be cancel and you will be refunded.</div>
                            </div>
                            ...
                            <div class="toggle">
                                ...
                                <div class="toggle-content">No, we respect your confidentiality as a patient. Our chat system is end to end, ie between you and your doctor. Not even the admin can read your chats. But your doctor can write clinical note about your health condition which will be visible to the next doctor you are going to see, to serve as a guide.</div>
                            </div>
                        </div>
