...
<footer id="footer">
    <div class="container">
      ...
      <div class="social-links">
        ...
        <a href="https://t.me/chatdoc" class="telegram"><i class="bx bxl-telegram"></i></a>
      </div>
      <div class="copyright">
        &copy; Copyright <strong><span>ChatDoc</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://horizon.com.ng/">Horizon IT Services</a>
      </div>
    </div>
  </footer><!-- End Footer -->
  ...
  <script src="{{ asset('/website/js/swipe.js') }}"></script>