...
<div class="row">
    ...
    <div style="width: 100%; overflow: auto; clear:both; margin-top: 10px;">
        <div class="col-md-12">
            <table class="table-sm table-bordered table-striped dt-responsive" style="width: 100%;">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" class="text-center"  style="width: 20%;">Name</th>

                        <th colspan="10" class="text-center" style="vertical-align:middle; width:75%;">Affix Date at the bottom
                            <tr>
                                ...
                                <th class="text-center"  style="width: 5%;">VII</th>
            ...
            <table class="table-sm table-bordered table-striped dt-responsive" style="width: 50%; margin-top: 20px;">
                <thead>
            <tr>
                <th style="width: 10%" class="text-center">Column</th>
                <th style="width: 30%">Date Taken</th>
                <th style="width: 10%" class="text-center">Column</th>
                <th style="width: 30%">Date Taken</th>
            </tr>
        </thead>
