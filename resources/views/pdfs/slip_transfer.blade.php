...
<div class="row">
    <div class="col-md-12">
       <table width="100%">
           <tr>
               <td class="text-center" width="15%">
                   <img  src="{{public_path('/uploads/').$institution->username.'/'.$institution->logo}}" style="width: 80px; height: 80px;">
               </td>
       ...
       <div style="margin-top: -30px;">
        <h5 style="text-align: center; border-bottom: 2px solid black; padding:5px;"><strong>Invoiced to:</strong> {{$user->roll_number}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>Total Amount Due:</strong> NGN{{number_format($sum,0)}}</h5>
       </div>
    </div>
    ...
    <div style="width: 100%">
        ...
        <div style="width:45%; float: right;">
            ...
            <p style="margin-top: -15px;"><strong>Account Name:</strong> {{$institution->first_acct_name}}</p>
            <p style="margin-top: -15px;"><strong>Account No/Bank:</strong> {{$institution->first_acct_no}} ({{$institution->first_bank_name}})</p>
            <p style="margin-top: -15px;"><strong>Account Name:</strong> {{$institution->second_acct_name}}</p>
            <p style="margin-top: -15px;"><strong>Account No/Bank:</strong> {{$institution->second_acct_number}} ({{$institution->second_bank_name}})</p>
        </div>
    </div>

    <div style="width: 100%; clear: both; overflow: auto; border-top: 2px solid black;">
        <{{$institution->heading}} style="font-size: 20px; text-align: center; text-transform: uppercase; margin-top: 0px;">{{$institution->name}} - STUDENT PAYMENT SLIP</{{$institution->heading}}>
        <h2 style="font-size: 16px; text-align: center; font-style: italic; margin-top: -15px;">{{$institution['session']['name']}} Session - {{$institution->term}} Term Fee Collection</h2>
    </div>
    <div style="border:  2px solid black; width: 100%; clear: both; overflow: auto; margin-top: -10px;">
    ...
    <div style="width: 100%; overflow: auto; clear:both; margin-top: -20px;">
        <div style="width: 80%; margin: 0 auto;">
            ...
            <table border="1"  class="content-table" >
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><strong>NGN{{number_format($sum,0)}}</strong></td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <div style="width: 90%; margin: 0 auto; overflow: auto; clear:both; margin-top: 30px;">
                    ...
                    <li><p style="margin-top: -15px;">Make payment to one of the above account numbers or in the school premises.</p></li>
                    <li><p style="margin-top: -15px;">Verify your payment by login to your dashboard > Payment Notification.</p></li>
                    <li><p style="margin-top: -15px;">You will be notified after processing your payment. can generate Receipt from your dashboard.</p></li>
                    <li><p style="margin-top: -15px;">Busy parents are encouraged to transfer directly to the above account number.</p></li>
    ...
    <div style=" width: 100%; overflow: auto; clear:both; margin-top: 10px;">
        ...
        <div style="width: 80%; float: right;">
            <h4 style="font-size: 17px; text-align: center">This Payment Schedule is to be paid before midnight of {{\Carbon\Carbon::parse($deadline)->format('l jS M, Y')}}</h4>
        </div>
    </div>
