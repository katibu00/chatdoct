...
<div class="row">
    <div class="col-md-12">
       ...
       <div style="margin-top: -40px;">
        <h4 style=" text-align: center; border-bottom: 2px solid black; padding:5px;">Class: {{$class->name}} {{$section->name}}  &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; Students' End of Term Report Form (Broadsheet)  &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;<span style="margin-right: 0">Term: {{$school->term}} Term &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; {{$school['session']['name']}} Session</span></h4>
       </div>
    </div>
