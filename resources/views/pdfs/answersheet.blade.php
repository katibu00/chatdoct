...
<div class="row">
    ...
    <div style="width: 100%">
        ...
        <div style="width:17%; float: left; ">
            <p style="margin-top: 10px; margin-left: 0px;"><img @if($user->image == 'default.png') src="{{asset("uploads/default.png")}}"  @else src="{{asset("uploads/").$institution->username.'/'.$user->image}}" @endif style="width: 100px; height: 100px;"></p>
      </div>
    ...
    <div style="width: 100%; overflow: auto; clear:both; margin-top: 10px;">
            ...
            <div style="width: 100%;  text-align: center;">
                <img src="/uploads/answer.jpg" style="width: 80%; ">
            </div>
