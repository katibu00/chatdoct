        ...
        <div class="container" style="margin-top: -30px;">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div style="margin-top: -30px;">
                        <h4
                            ...
                            <strong>Student's End of Term Report Form - Comment-Based</strong>
                        </h4>
                    </div>
                </div>
                ...
                <div style="width: 100%; overflow: auto; clear:both; margin-top: 30px;">
                    ...
                    <p
                        style="text-align: center; text-transform: uppercase; width: 95%; border-bottom: 2px solid black; padding: 5px;">
                        REMARKS</p>


                    @php
                        $principal = App\Models\PComment::where('school_id', $school_id)
                            ->where('user_id', $user->id)
                            ->where('session_id', $session_id)
                            ->where('term', $term)
                            ->where('class_id', $class_id)
                            ->where('class_section_id', $class_section_id)
                            ->first();
                        $master = App\Models\FComment::where('school_id', $school_id)
                            ->where('user_id', $user->id)
                            ->where('session_id', $session_id)
                            ->where('term', $term)
                            ->where('class_id', $class_id)
