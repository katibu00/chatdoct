                ...
                <div class="col-sm-12">
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            ...
                            <a class="btn btn-info pull-right  btn-sm" href="{{ route('register.applicant') }}"><i
                                    class="fa fa-user"></i> New Application</a>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($allData as $key => $value)
                                            <tr>
                                                ...
                                                <td><span class="badge iq-bg-primary">Pending</span></td>
                                ...
                                <div class="modal-dialog modal-lg">
                                   <div class="modal-content">
                                      <div class="modal-header">
                                         <h5 class="modal-title" id="exampleModalLabel">Edit Students Details</h5>
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <hr><div class="form-row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="first_name" class="form-control form-control-sm" value="{{$value->first_name}}">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>Middle Name</label>
                                                    <input type="text" name="middle_name" class="form-control form-control-sm" value="{{$value->middle_name}}">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>Last Name</label>
                                                    <input type="text" name="last_name" class="form-control form-control-sm" value="{{$value->last_name}}">
                                                </div>
                                        </div>
                                        <hr><div class="form-row">
                                            <div class="col-md-4">
                                        ...
                                        <hr><div class="form-row">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="roll_number" class="form-control form-control-sm" value="{{$value->roll_number}}">
                                            </div>
                                            <div class="col-md-4">
                                                <label>Gender</label>
                                        ...
                                        <hr><div class="form-row">
                                            <div class="col-md-4">
                                                ...
                                                <input type="date" name="dob" class="form-control form-control-sm" value="{{$value->dob}}">
                                            </div>
                                            <div class="col-md-8">
                                                <label>Contact Address</label>
                                                <input type="text" name="address" class="form-control form-control-sm" value="{{$value->address}}">
                                            </div>
                                        </div>
                                      </div>
