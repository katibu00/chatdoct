...
@section('PageTitle', 'Register Your School')
@section('content')
          ...
          <div class="col-lg-3">
                <div class="iq-card">
                   ...
                   <div class="iq-card-body">
                      ...
                      <form action="{{route('school.user.register')}}" method="post" enctype="multipart/form-data">
                        @csrf
                         <div class="form-group">
                            <div class="profile-img-edit">
                                <img class="profile-pic" src="/uploads/no-image.jpg" alt="profile-pic">
                                <div class="p-image">
