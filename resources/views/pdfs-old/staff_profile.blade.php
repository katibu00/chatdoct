                ...
                <table width="100%">
                    <tr>
                        <td class="text-center" width="15%">
                            <img src="{{asset("uploads").'/'.$institution->username.'/'.$institution->logo}}"
                ...
                <div style="width: 100%; margin: 0 auto;">
                    <h4
                        ...
                        <li>Visit https://intellisas.net</li>
                         <li>Click login and enter your your login details as indicated above.</li>
                         <li>Change the default password for maximize your account security</li>
                         <li>You can visit the school website at https://intelisas.net/{{$institution->username}} for recent news, events and other updates.</li>
                         <li>You can monitor your childrens perfomance, pay fees, print results, and so much more using the portal.</li>
                        </ol>
