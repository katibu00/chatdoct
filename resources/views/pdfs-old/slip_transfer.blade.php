...
<div class="row">
    ...
    <div style="width: 100%">
        <div style="width: 50%; float: left;">
               ...
               <p style="margin-top: -15px;"><h5>REG. NUMBER:</strong> {{$user->roll_number}} </h5></p>
    ...
    <div style="width: 100%; overflow: auto; clear:both; margin-top: 30px;">
        <div style="width: 80%; margin: 0 auto;">
            ...
            <div style="width: 90%; margin: 0 auto; overflow: auto; clear:both; margin-top: 30px;">
                    ...
                    <li><p style="margin-top: -15px;">Make payment to one of the above account numbers or using remita gateway on our portal</p></li>
                    <li><p style="margin-top: -15px;">Verify your payment by entering your remita RRR used or your bank payment particulars</p></li>
                    <li><p style="margin-top: -15px;">After successful payment, Your purchased will be delivered to your email and you can find it in your dashboard</p></li>
                    <li><p style="margin-top: -15px;">You must submit your application before the set deadline.</p></li>
