            ...
            <div class="row">
                    ...
                    <table width="100%">
                        <tr>
                            <td class="text-center" width="15%">
                                <img src="{{asset("uploads").'/'.$school->username.'/'.$school->logo}}"
                ...
                <div style="width: 100%">
                    <div style="width: 40%; float: left;">
                        ...
                        <p style="margin-top: -15px; text-transform:uppercase;"><strong>Class: </strong>
                            {{ $user['class']['name'] }} {{ $user['class_section']['name'] }}</p>
                        {{-- <p style="margin-top: -15px;; text-transform:uppercase;"><strong>DEPARTMENT:</strong> {{$user['department']['name']}}</p> --}}
                    </div>
                    ...
                    <div style="width: 40%; float: left; margin-left: 0px;">
                        <p style="margin-top: -15px;"><strong>TERM:</strong> Term</p>
                        @php
                        ...
                        {{-- <p style="margin-top: -15px;"><strong>Average Score:</strong> {{$average}}</p> --}}
                    </div>
                ...
                <div style="width: 100%; overflow: auto; clear:both; margin-top: 30px;">
                    <div class="col-md-12">
                        <table border="1" width="100%" cellpadding="1" cellspacing="2">
                            <thead>
                                <tr>
                                    ...
                                    <th rowspan="2" class="text-center" style="vertical-align:middle;width:25%">Subject</th>
                                    <th colspan="3" class="text-center" style="vertical-align:middle; width:30%;">Term
                                       <tr>
                                            ...
                                            <th rowspan="1"  class="text-center" style="vertical-align:middle; width: 10%;">Average</th>
                                            <th rowspan="1"  class="text-center" style="vertical-align:middle; width: 10%;">Grade</th>
                                            <th rowspan="1"  class="text-center" style="vertical-align:middle; width: 15%">Remarks</th>
                                      </tr>
                                    </th>
                                </tr>
                            </thead>
                                ...
                                <tr>
                                   ...
                                   {{-- First Term --}}
                                    <td class="text-center">
                                        @php
                                        $marks = App\Models\Marks::where('user_id',$user->id)->where('class_id',$class_id)->where('class_section_id',$class_section_id)->where('term','First')->where('school_id',$school_id)->where('session_id',$session_id)->where('subject_id',$subject->subject_id)->get();
                                    ...
                                    <td class="text-center">
                                        @php
                                        $marks = App\Models\Marks::where('user_id',$user->id)->where('class_id',$class_id)->where('class_section_id',$class_section_id)->where('term','Second')->where('school_id',$school_id)->where('session_id',$session_id)->where('subject_id',$subject->subject_id)->get();
                                    ...
                                    <td class="text-center">
                                        @php
                                        $marks = App\Models\Marks::where('user_id',$user->id)->where('class_id',$class_id)->where('class_section_id',$class_section_id)->where('term','Third')->where('school_id',$school_id)->where('session_id',$session_id)->where('subject_id',$subject->subject_id)->get();
                                    ...
                                    @php
                                        ...
                                        $grade_marks = App\Models\Grade::where([['start_mark','<=',(int)$average_score],['end_mark','>=',(int)$average_score]])->first();
                        ...
                        <!--<p-->
                        <!--    style="text-align: center; text-transform: uppercase; width: 100%; border-bottom: 2px solid black; padding: 5px;">-->
                        <!--    REMARKS</p>-->

                        <!--<div style=" width: 100%; overflow: auto; clear:both; margin-top: -10px;">-->
                        <!--    <div style="width: 50%; float: left; text-align: center;">-->
                        <!--        <p-->
                        <!--            style="text-align: center; width: 80%; margin-left: 5%; margin-top: 7%; border-top: 1px solid black; padding: 5px;">-->
                        <!--            Principal</p>-->
                        <!--    </div>-->

                        <!--    <div style="width: 50%; float: right;">-->
                        <!--        <p-->
                        <!--            style="text-align: center; width: 80%; margin-left: 0%; margin-top: 7%; border-top: 1px solid black; padding: 5px;">-->
                        <!--            Form Master</p>-->
                        <!--    </div>-->
                        </div>
