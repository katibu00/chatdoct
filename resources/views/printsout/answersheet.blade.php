...
@section('PageTitle', 'Generate Answer Sheet')
@section('content')
    ...
    <div class="container-fluid">
       <div class="row">
          <div class="col-sm-12">
                <div class="iq-card">
                      <div class="iq-card-header d-flex justify-content-between">
                         <div class="iq-header-title">
                            <h4 class="card-title">Generate Answer Sheet</h4>
            ...
            <form method="POST" id="myForm" action="{{route('answersheet.generate')}}" target="_blank">
                @csrf
                 <div class="form-row">
