                        ...
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <label class="col-lg-4 col-form-label fw-bold fs-6">
                                    <span class="required">Weekdays</span>
                                    {{-- <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Phone number must be active"></i> --}}
                                </label>
                                <!--end::Label-->
                                <!--begin::Col-->
                                <div class="col-lg-8 fv-row">
                                    <select class="form-select form-select-solid" data-control="select2" multiple data-hide-search="false" data-placeholder="Weekdays Schedules" name="weekdays[]">
                                        <option value=""></option>
                                        <option value="Morning" @if(in_array("Morning",$weekdays)) selected @endif>Morning</option>
                                        <option value="Noon" @if(in_array("Noon",$weekdays)) selected @endif>Noon</option>
                                        <option value="Evening" @if(in_array("Evening",$weekdays)) selected @endif>Evening</option>
                                        <option value="Night" @if(in_array("Night",$weekdays)) selected @endif>Night</option>
                                    </select>                                  
                                    </div>
                                <!--end::Col-->
                            </div>
