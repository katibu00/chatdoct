                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img @if(Auth::user()->picture == 'default.png') src="/uploads/default.png" @else src="/uploads/avatar/{{Auth::user()->picture}}" @endif  alt="image" />
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{Auth::user()->first_name}} {{Auth::user()->middle_name}} {{Auth::user()->last_name}}</a>
                                        <a href="#">
                                    ...
                                    <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                        ...
                                        <!--end::Svg Icon-->{{Auth::user()->number}}</a>
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--end::Svg Icon-->
                                                <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="{{Auth::user()->balance}}" data-kt-countup-prefix="&#x20A6;">0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                        ...
                                        <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <!--end::Svg Icon-->
                                                <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="7" data-kt-countup-prefix="">0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                    ...
                    <div class="d-flex overflow-auto h-55px">
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item">
                                <a class="nav-link text-active-primary me-6" href="{{route('profile.settings',Auth::user()->id)}}">Settings</a>
                            </li>
                    ...
                    <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
                        ...
                        <div class="d-flex flex-stack flex-grow-1">
                            ...
                            <div class="fw-bold">
                                ...
                                <div class="fs-6 text-gray-700">Your have not made any payment. To start using services, please
