						...
						<form class="form w-100" id="register_form">
							...
							<div class="row fv-row mb-7">
								<div class="col-xl-6">
									...
									<input class="form-control form-control-lg form-control-solid" type="text" id="first_name" placeholder="First Name" name="first_name" />
								</div>
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">Last Name</label>
									<input class="form-control form-control-lg form-control-solid" type="text" id="last_name" placeholder="Last Name" name="last_name" />
								</div>
							</div>
